...
const ProjectTile: NextPage<ProjectProps> = ({ project }) => {
  ...
  return (
    ...
    >
      <div className="item-center z-10 flex w-full flex-col justify-between rounded-lg border-2 border-[#233329] bg-[#4D4730] p-6 text-white/90 shadow-2xl sm:items-start md:w-2/5 lg:w-1/3">
        <VisibilitySensor
